...
'''
print('Пример выполнения кода с применением Requests\n')
...
print('Пример выполнения кода с применением Pandas\n')

df_1 = pd.read_csv('population_by_age_group.csv') #Создание DataFrame из файла с расширением .csv

print(df_1.head()) #Отображает первые 5 строк DataFrame. Можно задать свое значение.
print(df_1.tail()) #Отображает последние 5 строк DataFrame. Можно задать свое значение.

print(df_1.describe()) #выводит сводную статистику всех числовых столбцов, такую как количество, среднее значение,
                # стандартное отклонение, диапазон и квартили

print(df_1.info(show_counts=True, memory_usage=True, verbose=True)) #устанавливаем аргумент show_counts равным True, что дает
...
print('Пример выполнения кода с применением Numpy\n')
